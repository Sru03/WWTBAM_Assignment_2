...
public class WWTBM_GamePageGui extends javax.swing.JFrame {
    ...
    public WWTBM_GamePageGui(int playerId, String playerName) {
        initComponents();
        setLocation(300,150);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        WWTBM_StartGameGui startGame = new WWTBM_StartGameGui(player_id, player_name, false);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        dispose();
        new WWTBM_StartGameGui(player_id, player_name, true).setVisible(true);
